...
JL_DLLEXPORT void jl_timing_show_location(jl_sym_t *file, int line, jl_module_t* mod, jl_timing_block_t *cur_block)
{
#ifdef USE_TRACY
    jl_timing_printf(cur_block, "%s:%d in %s",
                     gnu_basename(jl_symbol_name(file)),
                     line,
...
JL_DLLEXPORT void jl_timing_show_method_instance(jl_method_instance_t *mi, jl_timing_block_t *cur_block)
{
    ...
    jl_timing_show_location(def->file, def->line, def->module, cur_block);
}
...
JL_DLLEXPORT void jl_timing_show_method(jl_method_t *method, jl_timing_block_t *cur_block)
{
    ...
    jl_timing_show_location(method->file, method->line, method->module, cur_block);
}
...
JL_DLLEXPORT void jl_timing_show_macro(jl_value_t *macro, jl_value_t* lno, jl_module_t* mod, jl_timing_block_t *cur_block)
{
    ...
    jl_timing_show_location((jl_sym_t*)jl_fieldref(lno, 1),
